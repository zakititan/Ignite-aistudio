...
export const Route = createFileRoute("/preflight")({
  head: () => ({
    meta: [
      {
        title: "Pre-Flight 'Go-Live' Simulator & Technical Sandbox",
      },
      {
        name: "description",
        content:
          "Test lead form submissions, mobile tap targets, SSL certificates, SPF/DKIM spam scores, 404 error handling, and favicons before public launch.",
      },
      {
        property: "og:title",
        content: "Pre-Flight Go-Live Simulator & Verification Sandbox",
      },
      {
        property: "og:description",
        content:
          "Interactive sandbox simulations to test every customer touchpoint before announcing your website.",
      },
    ],
  }),
...
export function PreflightPage() {
  ...
  return (
    <AppShell
      title="Pre-Flight 'Go-Live' Simulator & Technical Sandbox"
      description="Safely test forms, mobile dialers, SSL certificates, email spam scores, and 404 pages in a sandbox before announcing your website."
      actions={
